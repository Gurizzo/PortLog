...
INSERT INTO USUARIO VALUES('3','3','almacen')
...
INSERT INTO CLIENTE VALUES('123456789254','PEPITO EL PRUEBAS','02/09/1994')
INSERT INTO CLIENTE VALUES('123456789234','Juancho','01/04/2020')
INSERT INTO CLIENTE VALUES('123456789211','Termineitor','13/03/2010')
INSERT INTO CLIENTE VALUES('123456789222','Jose Maria','22/09/2015')
INSERT INTO CLIENTE VALUES('123456789299','Maria Susana','05/01/2020')

/*ALTA PRODUCTO*/
INSERT INTO PRODUCTO VALUES('252426','PRODUCTO DE PRUEBA',300,25,1)
INSERT INTO PRODUCTO VALUES('252427','PRODUCTO DE PRUEBA3',500,21,1)
INSERT INTO PRODUCTO VALUES('252428','PRODUCTO DE PRUEBA4',50,5,1)
INSERT INTO PRODUCTO VALUES('252429','PRODUCTO DE PRUEBA5',200,2.5,1)
INSERT INTO PRODUCTO VALUES('252433','PRODUCTO DE PRUEBA5',200,2.5,2)
INSERT INTO PRODUCTO VALUES('252432','PRODUCTO DE PRUEBA5',200,2.5,3)
INSERT INTO PRODUCTO VALUES('252431','PRODUCTO DE PRUEBA5',200,2.5,3)
INSERT INTO PRODUCTO VALUES('252444','PRODUCTO DE PRUEBA5',200,2.5,4)
INSERT INTO PRODUCTO VALUES('252443','PRODUCTO DE PRUEBA5',200,2.5,4)
INSERT INTO PRODUCTO VALUES('252445','PRODUCTO DE PRUEBA5',200,2.5,5)

/*ALTA IMPORTACIONES*/
INSERT INTO IMPORTACION VALUES('25/03/2020','25/08/2020',1,300,250,13,1)
INSERT INTO IMPORTACION VALUES('25/03/2019','25/08/2019',1,400,250,20,1)
INSERT INTO IMPORTACION VALUES('25/03/2019','25/08/2019',2,700,250,5,1)
INSERT INTO IMPORTACION VALUES('25/03/2019','25/08/2019',5,700,250,10,1)
INSERT INTO IMPORTACION VALUES('25/03/2019','25/08/2019',5,700,250,11,1)
INSERT INTO IMPORTACION VALUES('25/03/2019','25/07/2019',3,1,250,1,1)
INSERT INTO IMPORTACION VALUES('25/03/2019','25/07/2019',7,1,250,1,1)
INSERT INTO IMPORTACION VALUES('25/03/2019','25/07/2019',8,1,250,1,1)
INSERT INTO IMPORTACION VALUES('25/03/2019','25/07/2019',8,1,250,33,0)
INSERT INTO IMPORTACION VALUES('25/03/2020','25/07/2020',10,1,1,1,1)


/*DATOS DESCUENTO*/
INSERT INTO DESCUENTO VALUES(5,10,2)

/*VERIFICO QUE SE CARGARAN*/
USE PortLog
SELECT * FROM CLIENTE
SELECT * FROM USUARIO
...
/*CONSULTA LISTAR*/
  ...
  select * from IMPORTACION	
  SELECT sum(cantidad) FROM IMPORTACION i, PRODUCTO p where p.Id = i.PRODUCTOID



  select  P.CODIGO, P.NOMBRE,SUM(i.CANTIDAD) AS CANTIDAD from PRODUCTO p, IMPORTACION i, CLIENTE c where   P.CLIENTEID = c.Id  GROUP BY P.CODIGO,P.NOMBRE
 

select sum(cantidad) from IMPORTACION 

  select * from PRODUCTO
SELECT P.CODIGO,P.NOMBRE,SUM(I.CANTIDAD)AS CANTIDAD
                FROM PRODUCTO P, IMPORTACION I 
                WHERE P.Id = I.PRODUCTOID  
                GROUP BY P.CODIGO,P.NOMBRE

				
				select distinct SUM(I.CANTIDAD)
                FROM PRODUCTO P, IMPORTACION I 
                WHERE P.Id = I.PRODUCTOID 
                GROUP BY P.CODIGO,P.NOMBRE